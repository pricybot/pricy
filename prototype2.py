...
def classify(sentence, show_details=False):
    ...
    try:
        ...
        elif return_results[0][0] == "model1" or return_results[0][0] == "model2" or return_results[0][0] == "model3" or return_results[0][0] == "samsung" or return_results[0][0] == "samsung1" or return_results[0][0] == "samsung2" or return_results[0][0] == "samsung3":
...
while True:
    ...
    stop_words.extend(['guys', 'please', 'want', 'buy', 'mobile', 'phone', 'hi', 'pricy', 'Pricy', 'phones', 'mobiles', 'whats', 'what\'s', 'hm', 'so', 'hmm', 'um','ok',
                               'need', '?', 'available', 'u', 'sell', 'devices', 'device', 'brands', 'nepal', 'know','price', 'market', 'provide', 'me',
                               'current', 'value', 'tell', 'hello', 'pricy', 'how', 'are', 'you', 'brand', 'give', 'show', 'samsung', 'lg', 'motorola', 'lenevo',
                               'nokia', 'huawei', 'micromax', 'Price', 'model', 'galaxy', 'Galaxy', 'about', 'compare', 'you', 'have', 'get', 'nokia', 'vivo'])
    filtered_model = [w for w in word_tokens if not w in stop_words]
    filtered_model = []
    for w in word_tokens:
        if w not in stop_words:
    ...
    model_list =["j7", "j8", "j9", "v7", "a1", "redmi note 5", "desire 816", "968"]
